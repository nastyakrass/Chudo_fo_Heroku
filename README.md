...
(UPD: Для более яркого результата лучше отправлять на Супер резолюцию (Forward-ом фото) те картинки -- желательно, размера 256 на 256, -- к которым бот уже применил перенос стиля
...
Мой телеграм для связи: @nastyakrass
