...
Бот **@Enotuskabot** запущен на Heroku, с картинками 128 на 128 он работает хорошо, даже вытягивает асинхронный режим,  но они не такие красивые :-) (лучше выбирать графичные стилевые картинки: репродукции Пискассо, Матисса и др.).
